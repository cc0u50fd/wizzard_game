...
| Pip Pip | Grimshaw's familiar (companion) | Relentlessly cheerful, speaks entirely in wellness buzzwords, genuinely cares, catastrophically unskilled | Permanently bonded via a Grade C exam explosion; more or less indestructible; mistakes sarcasm for progress; has kept a chart of Grimshaw's 'yes' responses |
